...
### Changed
- **Bash pattern prefix matching**: Command patterns now require start-of-line or shell operator prefix (`&&`, `||`, `;`, `|`) to prevent false positives from command names appearing in strings, URLs, or file paths.
